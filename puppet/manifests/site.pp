...
# The gitlab droplet ships with an ssllabs-frowned-upon ssl; I manually edited
#   sites-enabled/gitlab to use the ssllabs-approved cipher list and allow TLS 1.2.
# Backups:
